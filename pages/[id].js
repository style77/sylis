    ...
    if (id) {
      ...
      getDownloadURL(ref(storage, id))
        .then((url) => {
          ...
          if (
            codingExts.includes(
              id.split("_").splice(1).join("_").split(".").at(-1)
            )
          ) {
    ...
    <Layout>
      <head>
        ...
        <meta
          ...
          content="Uploaded to sylis"
          key="description"
        />
        <meta property="og:site_name" content="Sylis" />
        ...
        {audioExts.includes(fileName.split(".").at(-1)) && (
            ...
            <Stack display="block">
              ...
              >
                <Stack align="center" marginTop="25px">
                  <Icon
                    as={get(iconMap, fileName.split(".").at(-1), FaFile)}
                    fontSize="60px"
                  />
              ...
              <Stack align="center" marginTop="25px">
                {imageExts.includes(fileName.split(".").at(-1)) ? (
                  <Box align="center" zIndex="1000">
                    <Image src={fileUrl} width="70vw" height="auto" />
                  </Box>
                ) : (
                  <></>
                )}
